            ...
            >
                <div class="absolute inset-0 overflow-hidden" aria-hidden="true">
                    <img
                        ...
                        alt="{{ $backgroundAlt }}"
                        class="h-full w-full scale-[1.06] object-cover object-[center_35%] opacity-95 saturate-100 contrast-[1.08] motion-safe:animate-auth-slow-pan"
                    >
                    <div class="absolute inset-0 bg-[radial-gradient(120%_90%_at_80%_0%,rgba(255,255,255,.56)_0%,rgba(243,245,250,.44)_45%,rgba(234,238,246,.40)_100%)]"></div>
                    <div class="absolute inset-0 bg-[linear-gradient(110deg,rgba(255,255,255,.66)_0%,rgba(255,255,255,.42)_34%,rgba(255,255,255,.18)_60%,rgba(246,248,252,.48)_100%)]"></div>
