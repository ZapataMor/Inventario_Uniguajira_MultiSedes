    ...
    */
    ...
    'connections' => [
        ...
        */
        ...
        |----------------------------------------------------------------------
        |
        | This connection works as a template only. The active tenant
        | overwrites database, username and password at runtime.
        | It must never silently fall back to the central database.
        |
        */
